...
#	pl.figure()
	Q = pl.quiver( R , Z , Br, Bz , Mag , pivot='mid', scale=25, width =0.005,cmap=mpl.cm.autumn)
...
if False:
	...
	pl.xlabel('x [m]'); pl.ylabel('y [m]'); pl.title('Toroidal Field')

	pl.subplot(1,2,2); R,Z,Br,Bz,Mag=VectorVerticalField(VF)
